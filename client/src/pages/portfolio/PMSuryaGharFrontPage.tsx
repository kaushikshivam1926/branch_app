 ...
 */
const EditableSolarRow = React.memo(({
  label,
  value,
  onChange,
  placeholder,
...
EditableSolarRow.displayName = "EditableSolarRow";
          ...
          <div className="bg-white shadow-2xl rounded flex-shrink-0"
            ...
            <div style={{ border: "1.5px solid #0e7490", borderRadius: "3px", overflow: "hidden", marginBottom: "3mm" }}>
              ...
              <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "8pt", border: "0.5px solid #e0e0e0" }}>
                <tbody>
                  <EditableSolarRow label="Property Address (Installation)" value={propertyAddress} onChange={setPropertyAddress} placeholder="Installation site address" />
                  <EditableSolarRow label="Solar Panel Capacity (kW)" value={solarCapacity} onChange={setSolarCapacity} placeholder="e.g. 3 kW" />
                  <EditableSolarRow label="Solar Installer Name" value={installerName} onChange={setInstallerName} />
                  <EditableSolarRow label="Installer Registration No." value={installerRegNo} onChange={setInstallerRegNo} />
                  <EditableSolarRow label="Central Subsidy Amount (₹)" value={subsidyAmount} onChange={setSubsidyAmount} placeholder="e.g. 78,000" />
                  <EditableSolarRow label="DISCOM Name" value={discomName} onChange={setDiscomName} placeholder="e.g. MSEDCL, BESCOM..." />
                  <EditableSolarRow label="Consumer Number" value={consumerNo} onChange={setConsumerNo} />
                  <EditableSolarRow label="Net Metering Connection No." value={netMeteringNo} onChange={setNetMeteringNo} />
                  <EditableSolarRow label="Est. Annual Generation (kWh)" value={annualGeneration} onChange={setAnnualGeneration} placeholder="e.g. 4,500 kWh" />
                </tbody>
              </table>
            </div>
