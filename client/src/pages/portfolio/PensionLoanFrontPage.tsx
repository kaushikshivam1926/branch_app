 ...
 */
const EditablePensionRow = React.memo(({
  label,
  value,
  onChange,
  placeholder,
  ...
  const inputStyle: React.CSSProperties = {
    width: "100%",
    border: "none",
    borderBottom: "1.5px solid #1a7a4a",
    outline: "none",
    fontSize: "8.5pt",
...
EditablePensionRow.displayName = "EditablePensionRow"
          ...
          >
            ...
            <div style={{ border: "1.5px solid #1a7a4a", borderRadius: "3px", overflow: "hidden", marginBottom: "3mm" }}>
              ...
              <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "8pt", border: "0.5px solid #e0e0e0" }}>
                <tbody>
                  <EditablePensionRow label="PPO Number" value={ppoNumber} onChange={setPpoNumber} />
                  <EditablePensionRow label="Pension Account Number" value={pensionAcctNo} onChange={setPensionAcctNo} />
                  <EditablePensionRow label="Pension Account Type" value={pensionAcctDesc} onChange={setPensionAcctDesc} />
                  <EditablePensionRow label="Pension Paying Authority" value={payingAuthority} onChange={setPayingAuthority} placeholder="e.g. CPPC, Treasury…" />
                  <EditablePensionRow label="Type of Pension" value={pensionType} onChange={setPensionType} type="select" />
                  <EditablePensionRow label="Monthly Pension Amount (₹)" value={monthlyPension} onChange={setMonthlyPension} placeholder="e.g. 25,000" />
                  <EditablePensionRow label="Date of Retirement" value={retirementDate} onChange={setRetirementDate} placeholder="DD/MM/YYYY" />
                  <EditablePensionRow label="Employer / Department" value={employer} onChange={setEmployer} placeholder="e.g. Govt. of Maharashtra" />
                  <EditablePensionRow label="Pensioner's Age (years)" value={pensionerAge} onChange={setPensionerAge} placeholder="e.g. 65" />
                </tbody>
              </table>
            </div>
