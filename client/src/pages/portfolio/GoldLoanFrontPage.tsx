...
/**
 * EditableGoldRow Component
 * Extracted outside main component to prevent re-creation on every state update
 * Using React.memo to prevent unnecessary re-renders
 * This preserves input focus when typing - fixes cursor/focus loss issue
 */
const EditableGoldRow = React.memo(({
  label,
  value,
  onChange,
  placeholder,
...
EditableGoldRow.displayName = "EditableGoldRow";
          ...
          <div className="bg-white shadow-2xl rounded flex-shrink-0"
            ...
            <div style={{ border: "1.5px solid #b8860b", borderRadius: "3px", overflow: "hidden", marginBottom: "3mm" }}>
              ...
              <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "8pt", border: "0.5px solid #e0e0e0" }}>
                <tbody>
                  <EditableGoldRow label="Ornament Description" value={ornamentDesc} onChange={setOrnamentDesc} placeholder="e.g. Necklace, Bangles, Earrings..." />
                  <EditableGoldRow label="Total Weight (grams)" value={totalWeight} onChange={setTotalWeight} placeholder="e.g. 25.5 g" />
                  <EditableGoldRow label="Purity / Carats" value={purity} onChange={setPurity} placeholder="e.g. 22 Carat / 916 Hallmark" />
                  <EditableGoldRow label="Appraised Value (₹)" value={appraisedValue} onChange={setAppraisedValue} placeholder="e.g. 1,50,000" />
                  <tr style={{ borderBottom: "0.5px solid #e0e0e0" }}>
                  ...
                  <EditableGoldRow label="Appraiser Name" value={appraiserName} onChange={setAppraiserName} />
                  <EditableGoldRow label="Appraisal Date" value={appraisalDate} onChange={setAppraisalDate} placeholder="DD/MM/YYYY" />
                  <EditableGoldRow label="Pledge Register Folio No." value={pledgeRegFolio} onChange={setPledgeRegFolio} />
                </tbody>
              </table>
            </div>
